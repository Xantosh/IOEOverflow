...
from main.views import index, forum, questionPost, search, particularPost, registerUser, loginUser, logoutUser, upvote_increment, downvote_increment, freshStart, delete_post
...
urlpatterns = [
    ...
    path('posts/del', delete_post, name='del')
